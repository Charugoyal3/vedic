define(["sugar-web/activity/activity"], function(activity) {
    ...
    requirejs(["domReady!"], function(doc) {
        ...
        document
            .getElementById("show-all-tricks")
            .addEventListener("click", function() {
                ...
                document.getElementById("learn-now").style.visibility =
                    "visible";
                document.getElementById("learn-the-trick").style.display =
                    "none";
                document.getElementById("learn-the-trick").style.visibility =
                    "hidden";
                document.getElementById("learn-a-trick").style.display = "none";
                document.getElementById("learn-a-trick").style.visibility =
                    "hidden";
                document.getElementById("show-all-tricks").style.display =
                    "none";
                document.getElementById("show-all-tricks").style.visibility =
                    "hidden";
                document.getElementById("calculator-challenge").style.display =
                    "none";
                ...
                var trick_green_board = document.getElementById(
                    "welcome-board"
                );
                trick_green_board.innerHTML =
                    "<p id=tuto2-step > </p>" + tricksList[trick_show_counter];
        ...
        document
            ...
            .addEventListener("click", function() {
                ...
                document.getElementById("learn-the-trick").style.visibility =
                    "visible";
                document.getElementById("let-me-try-the-trick").style.display =
                    "block";
                document.getElementById(
                ...
                var initial_message_green_board =
                    "Today, My teacher taught me the trick to ";
                ...
                trick_green_board.innerHTML =
                    initial_message_green_board +
                    homework_questions[trick_show_counter];
                console.log(trick_show_counter, "learn now");
            });
        var tutorial_example_step_counter = 0;
        document
            .getElementById("learn-the-trick")
            .addEventListener("click", function() {
                document.getElementById("learn-the-trick").style.display =
                    "none";
                document.getElementById("learn-the-trick").style.visibility =
                ...
                document.getElementById("next-step").style.visibility =
                    "visible";
                document.getElementById("start-over").style.display = "block";
                document.getElementById("start-over").style.visibility =
                    "visible";
                document.getElementById("curiosity-clicks").style.display =
                    "block";
                document.getElementById("curiosity-clicks").style.visibility =
                    "visible";
                document.getElementById("welcome-board").style.backgroundImage =
                    "url(../Vedic.activity/img/board.jpg)";
                ...
                trick_green_board.innerHTML =
                    "<p id='tuto-step'>" +
                    tutorial_steps[tutorial_example_step_counter] +
                    "</p>\
			<div><ul id='example_step_list'></ul></div>\
			<p id='exam-step'>" +
                    example_steps[tutorial_example_step_counter] +
                    "</p>\
                ...
                document
                    ...
                    .addEventListener("click", function() {
                        if (
                            ...
                            tutorial_example_step_counter < example_steps.length
                        ) {
                            document.getElementById("tuto-step").innerHTML =
                                tutorial_steps[tutorial_example_step_counter];
                            document.getElementById("exam-step").innerHTML =
                                example_steps[tutorial_example_step_counter];
                            var node = document.createElement("LI");
                            var text =
                                example_steps[
                                    tutorial_example_step_counter - 1
                                ];
                            ...
                            document
                                .getElementById("example_step_list")
                                .appendChild(node);
                            tutorial_example_step_counter++;
                        } else {
                            ...
                            document.getElementById("done").style.display =
                                "block";
                            document.getElementById("done").style.visibility =
                                "visible";
                            document.getElementById(
                                "curiosity-clicks"
        ...
        document
            .getElementById("curiosity-clicks")
            .addEventListener("click", function() {
                ...
                document.getElementById("welcome-board").style.width = "900px";
                document.getElementById("welcome-board").style.height = "640px";
                chosen_curiosity_steps =
                    all_explanation_steps[trick_show_counter];
                curiosity_steps = [];
                ...
                // var bottom_permanent_message = "<p>To learn a step again, We recommend to start over as it helps you learn it meaningfully!</p>";
                trick_green_board.innerHTML =
                    "<div><ul id='curiosity_step_list'></ul></div>\
			<p id='curiosity-step'>" +
                    curiosity_steps[curiosity_step_counter] +
                    "</p>\
			";
                ...
                document
                    ...
                    .addEventListener("click", function() {
                        if (curiosity_step_counter < curiosity_steps.length) {
                            ...
                            var node = document.createElement("LI");
                            var text =
                                curiosity_steps[curiosity_step_counter - 1];
                            var textnode = document.createTextNode(
                                "Step" + curiosity_step_counter + " :" + text
                            );
                            node.appendChild(textnode);

                            document
                                .getElementById("curiosity_step_list")
                                .appendChild(node);
                            curiosity_step_counter++;
                        } else {
                            console.log("tutorial ends");
        ...
        function setQuestion(a) {
            switch (a) {
                ...
                case 1:
                    ...
                    var answer_helper_middle = "";
                    var answer_helper_left =
                        question_num + " - " + (100 - question_num);
                    var answer_helper_right =
                        "Square of " + (100 - question_num);
                    var ret = {
                        question_num: question_num,
                        question_txt: question_txt,
                        answer_helper_left: answer_helper_left,
                ...
                case 3:
                    ...
                    var answer_helper_middle = "";
                    var answer_helper_left =
                        question_num + " + " + (question_num - 100);
                    var answer_helper_right =
                        "Square of " + (question_num - 100);
                    var ret = {
                        question_num: question_num,
                        question_txt: question_txt,
                        answer_helper_left: answer_helper_left,
                ...
                case 7:
                    ...
                    var answer_helper_left =
                        ...
                        ")";
                    var answer_helper_right =
                        Math.floor(question_num_one % 10) +
                        " * " +
                        Math.floor(question_num_two % 10);
        ...
        document
            .getElementById("let-me-try-the-trick")
            .addEventListener("click", function() {
                ...
                document.getElementById("welcome-board").style.backgroundImage =
                    "url(../Vedic.activity/img/homework_template_3.gif)";
                document.getElementById("welcome-board").style.width = "900px";
                document.getElementById("welcome-board").style.height = "640px";
			...
			<input type='text' id='let-me-try-the-trick-answer' placeholder='Your answer'>";
                ...
                ).innerHTML = values.question_txt;
                document.getElementById("left_helper").innerHTML =
                    values.answer_helper_left;
                document.getElementById("middle_helper").innerHTML =
                    values.answer_helper_middle;
                document.getElementById("right_helper").innerHTML =
                    values.answer_helper_right;
        ...
        function fun() {
            values = getQuestions(trick_show_counter);
            document.getElementById("let-me-try-the-trick-question").innerHTML =
                values.question_txt;
            document.getElementById("left_helper").innerHTML =
                values.answer_helper_left;
            document.getElementById("middle_helper").innerHTML =
        ...
        function getChallengeQuestion() {
            ...
            switch (chosen_challenge) {
                ...
                case 2:
                    ...
                    challenge_question_txt =
                        "( " + challenge_question + " ) * 9";
                    var ret_challenge = {
                        challenge_question: challenge_question,
                        challenge_question_txt: challenge_question_txt
                    };
                ...
                case 6:
                    ...
                    while (true) {
                        challenge_question = getRandomInt(10, 99);
                        if (
                            Math.floor(challenge_question / 10) +
                                Math.floor(challenge_question % 10) <
                            10
                        )
                            break;
        ...
        document
            .getElementById("calculator-challenge")
            .addEventListener("click", function() {
                ...
                trick_green_board.innerHTML =
                    "<div id='boy_monitor_penguin class='responsive'>\
			<div id='boy_at_desk'><img src='../img/boy_at_desk.png' style='height:320%; class='col-sm-6'></div>\
			<div id='monitor'><img src='../img/monitor.png '><div id='calculator_timer'>20 s</div><div id='calculator_questions_answered'>Correct answered:</div ></div>\
			<div id='penguin_using_computer'><img src='../img/penguin_using_computer.png'style='height:320%;></div>\
			</div>\
			<div id='calculator_questions'>On Your Mark<br />Get Set!</div>\
			";
                document.getElementById("calculator-go").style.display =
                    "block";
                document.getElementById("calculator-go").style.visibility =
                    "visible";
            });
    });
});
